#!/usr/bin/env python3
"""poc_forge php-sandbox runner.

Reads JSON request from stdin: {"script": "<php source>", "timeout_seconds": 30}
Writes /tmp/repro.php and runs `php /tmp/repro.php` with the timeout.
...
def main() -> int:
    ...
    with open("/tmp/repro.php", "w") as f:
        f.write(script)
